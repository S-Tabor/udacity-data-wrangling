...
Following the data wrangling process, some exploration and analysis of the (now clean and tidy) data was carried out, resulting in numerous interesting observations.
